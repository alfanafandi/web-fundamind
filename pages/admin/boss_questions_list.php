...
$totalResult = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM boss_questions");
$totalRows = mysqli_fetch_assoc($totalResult)['total'];
$totalPages = ceil($totalRows / $perPage);

$query = "SELECT id_question, id_boss, pertanyaan, pilihan_a, pilihan_b, pilihan_c, pilihan_d, jawaban_benar, petunjuk FROM boss_questions ORDER BY id_question ASC LIMIT $perPage OFFSET $offset";
...
<head>
    <meta charset="UTF-8">
    <title>Daftar Boss Questions</title>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-bold text-gray-800">Daftar Boss Questions</h2>
                <a href="index.php?modul=boss_question&fitur=create" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                    + Tambah Soal Boss
                </a>
            </div>
                ...
                <table class="min-w-full table-auto text-sm">
                    <thead class="bg-gray-800 text-white uppercase">
                        <tr>
                            ...
                            <th class="px-2 py-3 w-14 text-center">Boss</th>
                    ...
                    <tbody class="text-gray-700">
                        <?php while ($q = mysqli_fetch_assoc($result)) : ?>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-2 py-3 text-center"><?php echo $q['id_boss']; ?></td>
                                ...
                                <td class="px-2 py-3 text-center space-x-2">
                                    <a href="index.php?modul=boss_question&fitur=edit&id=<?php echo $q['id_question']; ?>" class="text-blue-600 hover:underline">Edit</a>
                                    <a href="index.php?modul=boss_question&fitur=delete&id=<?php echo $q['id_question']; ?>" onclick="return confirm('Yakin ingin menghapus soal ini?')" class="text-red-600 hover:underline">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
            ...
            <div class="mt-4 flex justify-center space-x-2">
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a href="?modul=boss_question&fitur=list&page=<?php echo $i; ?>"
